% Uses the TRAINED parameters (W,b) obtained when running train_perceptA_1PE to predict the labels of the TRAINING SETS (TSET1,TSET2,TSET3)

% FUNCTION DEFINITION
function predict_perceptA_1PE(W, b, TEST_DATA)
